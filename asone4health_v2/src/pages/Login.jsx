...
//TODO: fix the circle size in sm 
...
//navigate("/dashboard", { replace: true });
  ...
  return (
    <div className="w-full h-screen grid grid-rows-5 md:grid-cols-4 lg:grid-cols-4">
      ...
      {/* First Column */}
      <div className="lg:col-span-2  bg-color-main  md:cols-span-1 md:h-screen "></div>

      {/* Fourth Column */}

      <div className=" row-start-3 -mt-15 -mb-10 sm:row-start-4 sm:-mt-40 md:mr-3 inset-x-0 lg:max-h-screen lg:col-start-4 md:col-start-3 md:row-start-2 md:-left-[10vh]  bg-white flex  justify-center md:h-screen ">
        <div className="p-8 w-full max-w-md ">
          ...
          {/* New Section */}
          <section className="flex flex-col w-full items-center relative bottom-10 top-20 pb-10  ">
